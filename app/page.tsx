  ...
  return (
    <div className="relative min-h-screen bg-mjdat-dark text-mjdat-text-light overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-4 text-center">
        ...
        <section className="w-full max-w-6xl mx-auto py-16">
          <h2 className="text-4xl font-bold text-center mb-12 text-mjdat-green">Our Unique Approach</h2>
          <p className="text-lg text-center text-gray-300 mb-12 max-w-3xl mx-auto">
            We combine cutting-edge technology with human expertise to deliver unparalleled BPO solutions. Our process
            is designed for maximum efficiency and client satisfaction.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center bg-mjdat-dark/50 border border-mjdat-green/20 rounded-lg p-6 shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-mjdat-green">Agile Implementation</h3>
            ...
            <div className="flex flex-col items-center text-center bg-mjdat-dark/50 border border-mjdat-green/20 rounded-lg p-6 shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-mjdat-green">Data Security</h3>
              <p className="text-gray-300 text-sm mt-2">Robust protocols to protect your sensitive information.</p>
            </div>
            <div className="flex flex-col items-center text-center bg-mjdat-dark/50 border border-mjdat-green/20 rounded-lg p-6 shadow-lg">
              <TrendingUpIcon className="h-12 w-12 text-mjdat-green mb-4" />
              <h3 className="text-xl font-semibold text-mjdat-green">Continuous Optimization</h3>
              <p className="text-gray-300 text-sm mt-2">Always seeking ways to enhance performance and value.</p>
            </div>
          </div>
        </section>
